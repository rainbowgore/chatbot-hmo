...
def render_backend_status():
    ...
    if backend_status is True:
        ...
        if language == "he":
            st.markdown('<div style="direction: rtl; text-align: right; background-color: #fff3cd; color: #856404; padding: 12px; border-radius: 4px; border: 1px solid #ffeaa7; margin-bottom: 15px;">🟡 כבר מתחילים...</div>', unsafe_allow_html=True)
        else:
